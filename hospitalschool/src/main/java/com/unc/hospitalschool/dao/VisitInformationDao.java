...
public interface VisitInformationDao extends PagingAndSortingRepository<VisitInformation, Integer>{
	...
	Page<VisitInformation> findByStudentAndLogTypeOrderByDovDesc(Student student, LogType logType, Pageable pageable);
	Page<VisitInformation> findByStudentAndTeacherOrderByDovDesc(Student student, Teacher teacher, Pageable pageable);
	
	
	Page<VisitInformation> findByStudentAndTeacherAndLogTypeOrderByDovDesc(Student student, Teacher teacher, LogType logType, Pageable pageable);
