...
public class Student {
  ...
  public Student(String lastName, String firstName, String dob, Gender gender, RaceEth raceEth,
      ServiceArea serviceArea, School school, District district, County county, Grade grade,
      String studentNotes, String permissionDate, String label, PSLabel psLabel,
      Teacher currTeacher, Teacher secondTeacher, boolean clinic, boolean hispanic,
      boolean petTherapy, String newYrMessage) {
  ...
  public static boolean validateFields(Map<String, String> body) {
    ...
    return lName && fName && dob && gender && raceEth && servArea && school && district && county
        && grade && hispanic;
  }
  ...
  public String toString() {
    return "Student [sid=" + sid + ", lastName=" + lastName + ", firstName=" + firstName + ", dob="
        + dob + ", gender=" + gender + ", raceEth=" + raceEth + ", serviceArea=" + serviceArea
        + ", school=" + school + ", district=" + district + ", county=" + county + ", grade="
        + grade + ", studentNotes=" + studentNotes + ", permissionDate=" + permissionDate
        + ", label=" + label + ", psLabel=" + psLabel + ", currTeacher=" + currTeacher
        + ", secondTeacher=" + secondTeacher + ", clinic=" + clinic + ", hispanic=" + hispanic
        + ", petTherapy=" + petTherapy + ", newYrMessage=" + newYrMessage + "]";
  }
