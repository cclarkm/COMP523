...
public class ServiceAreaController {
  ...
  public ResponseEntity<Object> updateServiceArea(@RequestBody Map<String, String> body,
    ...
    if (serviceArea == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - serviceArea with sid: " + sid + " not found");
    }
    if (body.containsKey("field1")) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - serviceArea. Incorrect request field");
    }
  }
  ...
  public ResponseEntity<Object> deleteBySid(@PathVariable int sid) {
    ...
    if (serviceArea == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - serviceArea with sid: " + sid + " not found");
    } else {
