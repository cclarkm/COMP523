...
public class CountyController {
  ...
  public ResponseEntity<Object> postByCid(@RequestBody Map<String, String> body,
    ...
    if (county == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - county with cid: " + cid + " not found");
      // return new ResponseEntity<>(HttpStatus.OK);
    }
    if (body.containsKey("county")) {
  ...
  public ResponseEntity<Object> deleteByCid(@PathVariable int cid) {
    ...
    if (county == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - county with cid: " + cid + " not found");
    } else {
