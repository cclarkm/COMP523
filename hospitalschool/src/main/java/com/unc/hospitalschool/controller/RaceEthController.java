...
public class RaceEthController {
  ...
  public ResponseEntity<Object> updateRaceEth(@RequestBody Map<String, String> body,
    ...
    if (raceEth == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - raceEth with rid: " + rid + " not found");
    }
    if (!body.containsKey("raceEth") && !body.containsKey("code")) {
      logger.error("Unable to update - raceEth; incorrect request data");
      return ResponseEntity.badRequest()
          .body("Unable to update - raceEth. Incorrect request field");
    }
  ...
  public ResponseEntity<Object> deleteByRid(@PathVariable int rid) {
    ...
    if (raceEth == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - raceEth with rid: " + rid + " not found");
    } else {
