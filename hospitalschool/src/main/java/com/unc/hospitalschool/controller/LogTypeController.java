...
public class LogTypeController {
  ...
  public ResponseEntity<Object> updateLogType(@RequestBody Map<String, String> body,
    ...
    if (logType == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - logType with lid: " + lid + " not found");
    }
    if (body.containsKey("logType")) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - logType. Incorrect request field");
    }
  }
  ...
  public ResponseEntity<Object> deleteByLid(@PathVariable int lid) {
    ...
    if (logType == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - logType with lid: " + lid + " not found");
    } else {
