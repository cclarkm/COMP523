...
public class DistrictController {
  ...
  public ResponseEntity<Object> updateDistrict(@RequestBody Map<String, String> body,
    ...
    if (district == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - district with did: " + did + " not found");
    }
    if (body.containsKey("district")) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - district. Incorrect request field");
    }
  }
  ...
  public ResponseEntity<Object> deleteByDid(@PathVariable int did) {
    ...
    if (district == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - district with did: " + did + " not found");
    } else {
