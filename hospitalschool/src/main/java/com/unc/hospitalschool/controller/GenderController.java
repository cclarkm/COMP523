...
public class GenderController {
  ...
  @PutMapping(value = "/{id}")
  public ResponseEntity<Object> updateGender(@RequestBody Map<String, String> body,
      @PathVariable int id) {
    ...
    if (gender == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - gender with id: " + id + " not found");
    }
    if (body.containsKey("gender")) {
  ...
  public ResponseEntity<Object> deleteByGid(@PathVariable int id) {
    ...
    if (gender == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - gender with id: " + id + " not found");
    } else {
