...
public class GradeController {
  ...
  public ResponseEntity<Object> updateGrade(@RequestBody Map<String, String> body,
    ...
    if (grade == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update - grade with gid: " + gid + " not found");
    }
    if (body.containsKey("grade")) {
  ...
  public ResponseEntity<Object> deleteByGid(@PathVariable int gid) {
    ...
    if (grade == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - grade with gid: " + gid + " not found");
    } else {
