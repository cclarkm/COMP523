...
public class AdmissionsController {
  ...
  public ResponseEntity<Object> getAdmissionsByStudent(@PathVariable int sid,
    ...
    Page<Admission> temp =
        admissionDao.findByStudent(studentDao.findBySid(sid), goToPage(page, size));
  ...
  public ResponseEntity<Object> updateAdmission(@RequestBody Map<String, String> body,
