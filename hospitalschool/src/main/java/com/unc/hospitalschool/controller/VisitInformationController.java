...
public class VisitInformationController {
	...
	public ResponseEntity<Object> getLogsByStudent(@PathVariable int sid, @PathVariable int page,
		...
		Page<VisitInformation> temp = visitInformationDao.findByStudentOrderByDovDesc(studentDao.findBySid(sid),
				goToPage(page, size));
	...
	public ResponseEntity<Object> getLogsByStudentAndTeacher(@PathVariable int sid, @PathVariable int tid,
		...
		Page<VisitInformation> temp = visitInformationDao.findByStudentAndTeacherOrderByDovDesc(student, teacher,
				goToPage(page, size));
		for (VisitInformation visit : temp.getContent()) {
			jsons.add(visit.toJson());
		}
	...
	/*
	 * --------------------------------------------------------------------- GET
	 * LOGS BY STUDENT & TEACHER END
	 * ---------------------------------------------------------------------
	 */

	/*
	 * --------------------------------------------------------------------- GET
	 * LOGS BY STUDENT & TYPE START
	 * ---------------------------------------------------------------------
	 */
	...
	public ResponseEntity<Object> getLogsByStudentAndType(@PathVariable int sid, @PathVariable int lid,
		...
		Page<VisitInformation> temp = visitInformationDao.findByStudentAndLogTypeOrderByDovDesc(student, logType,
				goToPage(page, size));
		for (VisitInformation visit : temp.getContent()) {
			jsons.add(visit.toJson());
		}
	...
	/*
	 * --------------------------------------------------------------------- GET
	 * LOGS BY STUDENT & TYPE END
	 * ---------------------------------------------------------------------
	 */

	/*
	 * --------------------------------------------------------------------- GET
	 * LOGS BY STUDENT & TEACHER & TYPE START
	 * ---------------------------------------------------------------------
	 */
	@GetMapping(value = "/{sid}/tid={tid}/lid={lid}")
	public ResponseEntity<Object> getLogsByStudentAndTeacherAndType(@PathVariable int sid, @PathVariable int tid,
		...
		for (VisitInformation visit : visitInformationDao.findByStudentAndTeacherAndLogTypeOrderByDovDesc(student,
				teacher, logType)) {
			jsons.add(visit.toJson());
		}
		map.put("visits", jsons);
	...
	public ResponseEntity<Object> getLogsByStudentAndTeacherAndType(@PathVariable int sid, @PathVariable int tid,
		...
		Page<VisitInformation> temp = visitInformationDao.findByStudentAndTeacherAndLogTypeOrderByDovDesc(student,
				teacher, logType, goToPage(page, size));
		for (VisitInformation visit : temp.getContent()) {
			jsons.add(visit.toJson());
		}
		map.put("visits", jsons);
	...
	/*
	 * --------------------------------------------------------------------- GET
	 * LOGS BY STUDENT & TEACHER & TYPE END
	 * ---------------------------------------------------------------------
	 */
	...
	private void setVisitInformationFields(Map<String, String> body, VisitInformation visitInformation)
			throws Exception {
