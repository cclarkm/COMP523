...
public class VisitInformationController {
  ...
  public ResponseEntity<Object> getLogsByStudent(@PathVariable int sid) {
    ...
    for (VisitInformation visit : visitInformationDao
        .findByStudentOrderByDovDesc(studentDao.findBySid(sid))) {
  ...
  public ResponseEntity<Object> getLogsByStudent(@PathVariable int sid, @PathVariable int page,
    ...
    Page<VisitInformation> temp = visitInformationDao
        .findByStudentOrderByDovDesc(studentDao.findBySid(sid), goToPage(page, size));
  ...
  public ResponseEntity<Object> getLogsByStudentAndTeacher(@PathVariable int sid,
    ...
    for (VisitInformation visit : visitInformationDao.findByStudentAndTeacherOrderByDovDesc(student,
        teacher)) {
      jsons.add(visit.toJson());
    }
    map.put("visits", jsons);
  ...
  public ResponseEntity<Object> getLogsByStudentAndTeacher(@PathVariable int sid,
      @PathVariable int tid, @PathVariable int page, @PathVariable int size) {
    if (!validatePageAndSize(page, size)) {
      return ResponseEntity.badRequest().body("Page must be >= 0 and Size must be > 0");
    }
    ...
    Page<VisitInformation> temp = visitInformationDao.findByStudentAndTeacherOrderByDovDesc(student,
        teacher, goToPage(page, size));
    for (VisitInformation visit : temp.getContent()) {
      jsons.add(visit.toJson());
    }
    map.put("visits", jsons);
  ...
  public ResponseEntity<Object> getLogsByStudentAndType(@PathVariable int sid,
    ...
    for (VisitInformation visit : visitInformationDao.findByStudentAndLogTypeOrderByDovDesc(student,
        logType)) {
      jsons.add(visit.toJson());
    }
    map.put("visits", jsons);
  ...
  public ResponseEntity<Object> getLogsByStudentAndType(@PathVariable int sid,
      @PathVariable int lid, @PathVariable int page, @PathVariable int size) {
    if (!validatePageAndSize(page, size)) {
      return ResponseEntity.badRequest().body("Page must be >= 0 and Size must be > 0");
    }
    ...
    Page<VisitInformation> temp = visitInformationDao.findByStudentAndLogTypeOrderByDovDesc(student,
        logType, goToPage(page, size));
    for (VisitInformation visit : temp.getContent()) {
      jsons.add(visit.toJson());
    }
    map.put("visits", jsons);
  ...
  public ResponseEntity<Object> getLogsByStudentAndTeacherAndType(@PathVariable int sid,
      @PathVariable int tid, @PathVariable int lid) {
    Map<String, Object> map = new HashMap<String, Object>();
    List<Map<String, String>> jsons = new ArrayList<Map<String, String>>();
    ...
    for (VisitInformation visit : visitInformationDao
        .findByStudentAndTeacherAndLogTypeOrderByDovDesc(student, teacher, logType)) {
      jsons.add(visit.toJson());
    }
    map.put("visits", jsons);
    return new ResponseEntity<>(map, HttpStatus.OK);
  ...
  public ResponseEntity<Object> getLogsByStudentAndTeacherAndType(@PathVariable int sid,
      @PathVariable int tid, @PathVariable int lid, @PathVariable int page,
      @PathVariable int size) {
    if (!validatePageAndSize(page, size)) {
      return ResponseEntity.badRequest().body("Page must be >= 0 and Size must be > 0");
    }
    ...
    Page<VisitInformation> temp =
        visitInformationDao.findByStudentAndTeacherAndLogTypeOrderByDovDesc(student, teacher,
            logType, goToPage(page, size));
    for (VisitInformation visit : temp.getContent()) {
      jsons.add(visit.toJson());
    }
  ...
  public ResponseEntity<Object> newVisitInformation(@RequestBody Map<String, String> body) {
    ...
    if (!VisitInformation.validateFields(body)) {
      return ResponseEntity.badRequest()
          .body("Not all required VisitInformation parameters provided");
    }
    try {
  ...
  @PutMapping(value = "/{id}")
  public ResponseEntity<Object> updateVisitInformation(@RequestBody Map<String, String> body,
    ...
    if (visitInformation == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to update visitInformation with id: " + id + " not found");
    }
    try {
      this.setVisitInformationFields(body, visitInformation);
    } catch (Exception e) {
  ...
  public ResponseEntity<Object> deleteById(@PathVariable int id) {
    ...
    if (visitInformation == null) {
      ...
      return ResponseEntity.badRequest()
          .body("Unable to delete - visitInformation with id: " + id + " not found");
    } else {
  ...
  private void setVisitInformationFields(Map<String, String> body,
      VisitInformation visitInformation) throws Exception {
    for (String x : body.keySet()) {
      switch (x) {
        case "sid":
          Student student =
              studentDao.findBySid(FieldValidation.parseInt("sid", (body.get("sid"))));
          if (student == null) {
        ...
        case "logType":
          LogType type =
              logTypeDao.findByLid(FieldValidation.parseInt("logType", body.get("logType")));
          if (type == null) {
